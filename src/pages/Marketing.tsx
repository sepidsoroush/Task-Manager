...
export default function MarketingPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#F6F2EF] to-white dark:from-gray-900 dark:to-gray-800 font-sans antialiased overflow-x-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-1 gap-8 max-w-xl mx-auto">
            <div className="bg-white dark:bg-gray-900 p-8 rounded-lg shadow-sm border dark:border-gray-700">
              ...
              <Button
                className="hover:bg-white/90 dark:hover:bg-white/90 w-full"
                onClick={() => {
                  setAuthMode("signup");
                  setDialogOpen(true);
                }}
      ...
      {/* Footer */}
      <section className="py-10 bg-gray-900 dark:bg-gray-900/90">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <Link
            to="https://github.com/sepidsoroush/chore"
            className="text-white/90 dark:text-white/90 hover:underline underline-offset-4 dark:hover:text-white/90 text-xs"
            target="_blank"
          >
            Built by Sepideh Soroush
          </Link>
        </div>
      </section>
